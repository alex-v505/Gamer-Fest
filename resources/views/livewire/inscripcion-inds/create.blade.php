    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createDataModalLabel">Create New Inscripcion Ind</h5>
           ...
           <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <input wire:model="pago_ins" type="file" class="form-control" id="pago_ins" placeholder="Pago Ins">@error('pago_ins') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
